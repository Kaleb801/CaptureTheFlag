...
func _player_connected(id):
	...
	var stage = load("res://Maps/stage.tscn").instance() #Change to scene for testing
	stage.music=$Music
...
func _on_host_pressed():
	var audioStream=preload("res://Sounds/select_005.wav")
	$Effect.set_stream(audioStream)
	$Effect.play()
...
func _on_host_mouse_entered():
	var audioStream=preload("res://Sounds/select_002.wav")
	$Effect.set_stream(audioStream)
	$Effect.play()
